...
/**
 * 
 * core_Courses.java is used for reading reading the .csv for core courses
 * Details and storing them
 * 
...
public class core_Courses {
	 ...
	 *            - static list that contains Course objects which have the core
	 *            courses details
	 * @param obj
	 ...
	 * the static App.core_Course_List
	 * 
	 * @param args
	 *            - unused
	 * @throws IOException
