...
public class Day implements Serializable {
	...
	/**
	 * Constructor for initialising the day list with booleans for time slots
	 */
	public Day() {
		for (int i = 0; i < 20; i++) {
	...
	/**
	 * Getter function for day_List
	 * @return day_List(Boolean)
	 */
	...
	/**
	 * Function used for booking the slots of all the courses offered to CSE students in second semester
						...
						if (App.actual_Room_List.get(j).get_Name().equals(room[m])) {
							for (int k = 0; k < 20; k++) {
								for (int l = s; l < limit; l++) {
									App.actual_Room_List.get(j).getList_Of_Weeks().get(k).getWeek_List().get(0).day_List
											.set(l, true);
								}
							}
						}
				...
				for (int j = 0; j < App.actual_Room_List.size(); j++) {
					for (int m = 0; m < room.length; m++) {
						if (App.actual_Room_List.get(j).get_Name().equals(room[m])) {
							for (int k = 0; k < 20; k++) {
								for (int l = s; l < limit; l++) {
									App.actual_Room_List.get(j).getList_Of_Weeks().get(k).getWeek_List().get(1).day_List
											.set(l, true);
								}
							}
						}
				...
				for (int j = 0; j < App.actual_Room_List.size(); j++) {
					for (int m = 0; m < room.length; m++) {
						if (App.actual_Room_List.get(j).get_Name().equals(room[m])) {
							for (int k = 0; k < 20; k++) {
								for (int l = s; l < limit; l++) {
									App.actual_Room_List.get(j).getList_Of_Weeks().get(k).getWeek_List().get(2).day_List
											.set(l, true);
								}
							}
						}
				...
				for (int j = 0; j < App.actual_Room_List.size(); j++) {
					for (int m = 0; m < room.length; m++) {
						if (App.actual_Room_List.get(j).get_Name().equals(room[m])) {
							for (int k = 0; k < 20; k++) {
								for (int l = s; l < limit; l++) {
									App.actual_Room_List.get(j).getList_Of_Weeks().get(k).getWeek_List().get(3).day_List
											.set(l, true);
								}
							}
						}
				...
				for (int j = 0; j < App.actual_Room_List.size(); j++) {
					for (int m = 0; m < room.length; m++) {
						if (App.actual_Room_List.get(j).get_Name().equals(room[m])) {
							for (int k = 0; k < 20; k++) {
								for (int l = s; l < limit; l++) {
									App.actual_Room_List.get(j).getList_Of_Weeks().get(k).getWeek_List().get(4).day_List
											.set(l, true);
								}
							}
						}
