...
/**
 * For showing the room availabilty to the student booking the courses slots and
 * the extra booking slots by admin and faculty
 * 
 * @author sm_06
 *
 */
public class ViewRoomStudent extends Application {
	...
	public void start(Stage primaryStage) {
		...
		t21.setDisable(true);
		t21.setAlignment(Pos.CENTER);
		t22.setDisable(true);
		t22.setAlignment(Pos.CENTER);
		t23.setDisable(true);
		t23.setAlignment(Pos.CENTER);
		t24.setDisable(true);
		t24.setAlignment(Pos.CENTER);
		t25.setDisable(true);
		t25.setAlignment(Pos.CENTER);
		t26.setDisable(true);
		t26.setAlignment(Pos.CENTER);
		t27.setDisable(true);
		t27.setAlignment(Pos.CENTER);
		t28.setDisable(true);
		t28.setAlignment(Pos.CENTER);
		t29.setDisable(true);
		t29.setAlignment(Pos.CENTER);
		t30.setDisable(true);
		t30.setAlignment(Pos.CENTER);
		t31.setDisable(true);
		t31.setAlignment(Pos.CENTER);
		...
		tj.setDisable(true);
		tj.setAlignment(Pos.CENTER);
		tk.setDisable(true);
		tk.setAlignment(Pos.CENTER);
		...
		/**
		 * Shows all the rooms that are available and not available by
		 * traversing over the room booking list
		 */
		btn.setOnAction(e -> {
